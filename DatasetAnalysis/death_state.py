...
def death_state():  
    raw_death = pd.read_csv('Dataset/deaths_state.csv')
    ...
    if selectShow == 'Outliers Detection': 
        ...
        with left_column1:
            boxplot3 = alt.Chart(final_death).mark_boxplot().encode(
                y='deaths_bid:Q'
            ).properties(
                        width=350,
                        height=200,
        ...
        with right_column1:
            boxplot4 = alt.Chart(final_death).mark_boxplot().encode(
                y='deaths_bid_dod:Q'
            ).properties(
                        width=350,
                        height=200,
        ...
        with left_column2:
            boxplot5 = alt.Chart(final_death).mark_boxplot().encode(
                y='deaths_pvax:Q'
            ).properties(
                        width=350,
                        height=200,
        ...
        with right_column2:
            boxplot6 = alt.Chart(final_death).mark_boxplot().encode(
                y='deaths_fvax:Q'
            ).properties(
                        width=350,
                        height=200,
        ...
        with left_column3:
            boxplot7 = alt.Chart(final_death).mark_boxplot().encode(
                y='deaths_tat:Q'
            ).properties(
                        width=350,
                        height=200,
